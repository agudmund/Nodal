...
class BaseNode(QGraphicsRectItem):
    ...
    def __init__(self, node_id: int, title: str, pos: QPointF = QPointF(0, 0),
        ...
        # Logs device/widget types to identify ghost node rendering:
        #   QPixmap device = correct offscreen effect buffer rendering
        #   QWidget device = ghost node painting directly to viewport (see Ghost Node Investigation doc)
    ...
    def toggle_ports(self):
        ...
        Forces a repaint so the change is visible immediately.
        """
